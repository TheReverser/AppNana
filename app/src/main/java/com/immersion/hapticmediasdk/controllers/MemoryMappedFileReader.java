...
public class MemoryMappedFileReader implements IHapticFileReader {
    ...
    private void c() throws NotEnoughHapticBytesAvailableException, IOException {
        try {
            if (this.e != null) {
                int i = this.e.mHapticDataOffset + j;
                try {
                    this.d = this.e;
    ...
    private ccrrrr d(int i) throws IOException, NotEnoughHapticBytesAvailableException {
        ...
        if (i < this.i.getHapticDataLength()) {
            ...
            int hapticDataLength = i + j <= this.i.getHapticDataLength() ? j : this.i.getHapticDataLength() - i;
    ...
    public boolean bufferAtPlaybackPosition(int i) {
        try {
            ...
            int b = b(i);
            if (this.d == null || d(this.d, b)) {
                try {
                    if (this.e == null || d(this.e, b) || e(this.e, b)) {
                        try {
                            if (this.d == null || this.d.mHapticDataOffset != b) {
                                this.d = d(b);
                            }
                            if (this.e == null || this.e.mHapticDataOffset != b + j) {
                                this.e = d(b + j);
                            }
                            return true;
                        } catch (Exception e) {
                ...
                } catch (NotEnoughHapticBytesAvailableException e3) {
            ...
            if (this.d != null) {
                this.d.mMappedByteBuffer.position(a(this.d, b));
            }
            return true;
        } catch (Exception e5) {
            throw e5;
