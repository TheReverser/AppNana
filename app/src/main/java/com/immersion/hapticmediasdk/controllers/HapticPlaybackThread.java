...
public class HapticPlaybackThread extends Thread {
    ...
    private void a(Message message) {
        this.x = true;
        Message obtainMessage = this.h.obtainMessage(HAPTIC_DOWNLOAD_ERROR);
    ...
    public static /* synthetic */ int b0411БББ04110411(HapticPlaybackThread hapticPlaybackThread, int i) {
        ...
        if (((bЧ042704270427ЧЧ + b0427042704270427ЧЧ) * bЧ042704270427ЧЧ) % bЧЧЧЧ0427Ч != b0427Ч0427Ч0427Ч) {
            bЧ042704270427ЧЧ = 55;
            b0427Ч0427Ч0427Ч = HAPTIC_SET_BUFFERING_POSITION;
        }
        ...
        try {
            ...
            switch ((i * (b0427042704270427ЧЧ + i)) % bЧЧЧЧ0427Ч) {
                case Gender.MALE /*0*/:
                    break;
                default:
                    bЧ042704270427ЧЧ = HAPTIC_QUIT_PLAYBACK;
                    b0427Ч0427Ч0427Ч = 62;
                    break;
            }
            return handler;
    ...
    public static /* synthetic */ int bББ041104110411Б(HapticPlaybackThread hapticPlaybackThread, int i) {
        if (((bЧ042704270427ЧЧ + b0427042704270427ЧЧ) * bЧ042704270427ЧЧ) % b04270427Ч04270427Ч() != b0427Ч0427Ч0427Ч) {
            bЧ042704270427ЧЧ = HAPTIC_DOWNLOAD_ERROR;
            b0427Ч0427Ч0427Ч = b0427ЧЧЧ0427Ч();
        }
        try {
    ...
    private void d() {
        ...
        if (!this.x) {
            int i = this.r;
            this.r = i + HAPTIC_SET_BUFFERING_POSITION;
            if (i == HAPTIC_PAUSE_PLAYBACK) {
                this.h.sendMessage(this.h.obtainMessage(PAUSE_AV_FOR_HAPTIC_BUFFERING, this.p, 0));
                this.g.postDelayed(this.F, D);
            } else if (this.k == null || !this.k.bufferAtPlaybackPosition(this.p)) {
                this.g.postDelayed(this.F, D);
            } else if (this.q != b) {
                this.h.sendMessage(this.h.obtainMessage(HAPTIC_PLAYBACK_IS_READY, this.p, this.q));
            }
        }
    }
    ...
    public void pauseHapticPlayback() {
        ...
        this.g.sendEmptyMessage(HAPTIC_PAUSE_PLAYBACK);
        while (true) {
    ...
    public void prepareHapticPlayback(int i, int i2) {
        this.g.removeMessages(HAPTIC_SET_BUFFERING_POSITION);
        this.g.sendMessage(this.g.obtainMessage(HAPTIC_SET_BUFFERING_POSITION, i, i2));
    }

    public void quitHapticPlayback() {
        try {
            if (!this.g.sendEmptyMessage(HAPTIC_QUIT_PLAYBACK)) {
    ...
    public void stopHapticPlayback() {
        try {
            this.g.sendEmptyMessage(HAPTIC_STOP_PLAYBACK);
            int i = bЧ042704270427ЧЧ;
            switch ((i * (b0427042704270427ЧЧ + i)) % bЧЧЧЧ0427Ч) {
                case Gender.MALE /*0*/:
                    return;
