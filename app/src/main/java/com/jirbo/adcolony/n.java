...
class n {
    ...
    static class a {
        ...
        boolean a(g gVar) {
            ...
            this.a = gVar.e("uuid");
            this.b = gVar.e(ShareConstants.WEB_DIALOG_PARAM_TITLE);
            ...
            this.w = new p();
            if (!this.w.a(gVar.b(AnalyticsEvents.PARAMETER_SHARE_DIALOG_SHOW_NATIVE))) {
                return false;
            }
            this.s = new c();
            ...
            this.v = new aa();
            if (!this.v.a(gVar.b(AnalyticsEvents.PARAMETER_SHARE_DIALOG_CONTENT_VIDEO))) {
                return false;
            }
            this.x = new y();
    ...
    static class aa {
        ...
        boolean a(g gVar) {
            ...
            this.d = gVar.e(NativeProtocol.WEB_DIALOG_URL);
    ...
    static class ab {
        ...
        synchronized int a(a aVar) {
            ...
            i = -1;
            int i2 = aVar.p.g;
            if (i2 == 0 || a.ab == 0 || (System.currentTimeMillis() - a.ab) / 1000 < ((long) i2)) {
                i2 = aVar.p.h;
                if (i2 > 0) {
                    i = a(-1, i2 - a.l.h.a(aVar.d, (double) ((System.currentTimeMillis() - a.ab) / 1000)));
                }
                if (i != 0 || i2 == 0) {
                    i2 = this.c;
                    if (i2 > 0) {
    ...
    static class ac {
        ...
        boolean a(g gVar) {
            if (gVar != null) {
                this.a = gVar.a(ShareConstants.WEB_DIALOG_RESULT_PARAM_REQUEST_ID, null);
            }
            return true;
        }
    }
    ...
    static class e {
        ...
        boolean a(g gVar) {
            ...
            if (this.i == null || this.i.equals(BuildConfig.VERSION_NAME)) {
                this.i = "all";
            }
            if (this.j == null || this.j.equals(BuildConfig.VERSION_NAME)) {
                this.j = "all";
            }
            this.k = new f();
    ...
    static class f {
        ...
        boolean a(g gVar) {
            if (gVar != null) {
                ...
                this.b = gVar.a(Offer.TYPE_INSTALL, null);
                ...
                this.h.b(Offer.TYPE_INSTALL, this.b);
    ...
    static class l {
        ...
        boolean a(g gVar) {
            ...
            if (!this.e.equals(BuildConfig.VERSION_NAME)) {
                return true;
            }
            this.e = gVar.e("last_modified");
            return true;
    ...
    static class o {
        ...
        boolean a(g gVar) {
            ...
            this.b = gVar.e(NativeProtocol.WEB_DIALOG_URL);
    ...
    static class p {
        ...
        boolean a(g gVar) {
            ...
            this.e = gVar.e(ShareConstants.WEB_DIALOG_PARAM_DESCRIPTION);
            this.f = gVar.e(ShareConstants.WEB_DIALOG_PARAM_TITLE);
    ...
    static class w {
        ...
        boolean a(g gVar) {
            ...
            this.d.put(Offer.TYPE_INSTALL, this.b);
