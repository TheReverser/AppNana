...
public class ADCData {
    ...
    static class f extends i implements Serializable {
        ...
        boolean l() {
            ...
            if (toLowerCase.equals(ServerProtocol.DIALOG_RETURN_SCOPES_TRUE) || toLowerCase.equals("yes")) {
                return true;
            }
            return false;
        }
    ...
    static class g extends i implements Serializable {
        ...
        String e(String str) {
            return a(str, BuildConfig.VERSION_NAME);
        }
    ...
    public static void main(String[] args) {
        ...
        gVar.b("one", 1);
        gVar.b("pi", 3.14d);
        gVar.b(ShareConstants.WEB_DIALOG_PARAM_NAME, "\"Abe Pralle\"");
        gVar.a("list", new c());
        ...
        System.out.println(gVar.e(ShareConstants.WEB_DIALOG_PARAM_NAME));
        System.out.println(gVar.f(ShareConstants.WEB_DIALOG_PARAM_NAME));
        System.out.println(gVar.g(ShareConstants.WEB_DIALOG_PARAM_NAME));
