...
class ac extends h {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.G.getViewsPerReward() == 1) {
            a(this.F, BuildConfig.VERSION_NAME);
            if (s) {
            ...
            a(this.F, BuildConfig.VERSION_NAME + remainingViewsUntilReward + " more " + str + " to earn )?");
            if (s) {
                a("Watch a sponsored video now (Only", this.z, (int) (((double) this.A) - (((double) b) * this.l)), canvas);
                a(BuildConfig.VERSION_NAME + remainingViewsUntilReward + " more " + str + " to earn " + q + ")?", this.z, (int) (((double) this.A) - (((double) b) * this.m)), canvas);
            } else {
                a("Watch a sponsored video now (Only", this.z, (int) (((double) this.A) - (((double) b) * this.i)), canvas);
                a(BuildConfig.VERSION_NAME + remainingViewsUntilReward + " more " + str + " to earn " + q, this.z, (int) (((double) this.A) - (((double) b) * this.j)), canvas);
                a(r + ")?", this.z, (int) (((double) this.A) - (((double) b) * this.k)), canvas);
            }
        }
