...
class t {
        ...
        if (!this.f || ((a) this.b.get(this.b.size() - 1)).c != this.a.e.j) {
            ...
            if (b != null) {
                ...
                while (i < b2.o()) {
                    ...
                    this.c.put(Integer.valueOf(parseInt), Integer.valueOf(b2.g(BuildConfig.VERSION_NAME + parseInt)));
                    i++;
                }
                this.f = true;
            }
    ...
    void c() {
        ...
        for (Integer intValue : this.c.keySet()) {
            ...
            gVar2.b(BuildConfig.VERSION_NAME + intValue2, ((Integer) this.c.get(Integer.valueOf(intValue2))).intValue());
        }
