...
import com.appnana.android.utils.BuildConfig;
...
class c {
    ...
    String v;
    String w;
    String x = com.facebook.BuildConfig.VERSION_NAME;
    String y;
    String z;
    ...
    void a(String str) {
        if (str == null) {
            str = com.facebook.BuildConfig.VERSION_NAME;
        }
    ...
    void a() {
        ...
        this.e = 0;
        this.a.g.a();
        this.K = a(g.a, com.facebook.BuildConfig.VERSION_NAME);
        this.N = g.b;
        this.t = a(g.a(), com.facebook.BuildConfig.VERSION_NAME);
        if (this.K.equals(com.facebook.BuildConfig.VERSION_NAME)) {
            a = a(ab.b(this.t), com.facebook.BuildConfig.VERSION_NAME);
        } else {
            a = com.facebook.BuildConfig.VERSION_NAME;
        }
        this.u = a;
        this.w = a(g.b(), com.facebook.BuildConfig.VERSION_NAME);
        if (this.y == null) {
            this.y = a(g.e(), com.facebook.BuildConfig.VERSION_NAME);
        }
        this.z = a(g.l(), com.facebook.BuildConfig.VERSION_NAME);
        this.A = a(g.m(), com.facebook.BuildConfig.VERSION_NAME);
        this.E = a(g.j(), "en");
        this.F = a(g.n(), com.facebook.BuildConfig.VERSION_NAME);
        this.G = a(g.o(), com.facebook.BuildConfig.VERSION_NAME);
        this.J = a(com.facebook.BuildConfig.VERSION_NAME + VERSION.SDK_INT, com.facebook.BuildConfig.VERSION_NAME);
        this.C = a(g.h(), com.facebook.BuildConfig.VERSION_NAME);
        this.D = com.facebook.BuildConfig.VERSION_NAME;
        this.H = a(com.facebook.BuildConfig.VERSION_NAME + g.c(), com.facebook.BuildConfig.VERSION_NAME);
        this.I = a(com.facebook.BuildConfig.VERSION_NAME + g.d(), com.facebook.BuildConfig.VERSION_NAME);
        boolean z = ab.d() && ab.e();
        this.O = z;
        a.V = this.G;
        a.W = this.b;
        ...
        this.v = com.facebook.BuildConfig.VERSION_NAME;
        ...
        zVar.a(q.a(this.A));
        zVar.a("&screen_width=");
        zVar.a(q.a(com.facebook.BuildConfig.VERSION_NAME + g.f()));
        zVar.a("&screen_height=");
        zVar.a(q.a(com.facebook.BuildConfig.VERSION_NAME + g.g()));
        zVar.a("&sdk_type=");
        zVar.a(q.a(this.p));
        zVar.a("&sdk_version=");
        zVar.a(q.a(this.b));
        ...
        this.g = true;
        this.a.b.e();
        if (this.a.b.j.i == null || this.a.b.j.i.equals(com.facebook.BuildConfig.VERSION_NAME)) {
            this.a.b.j.i = "all";
        }
        if (this.a.b.j.j == null || this.a.b.j.j.equals(com.facebook.BuildConfig.VERSION_NAME)) {
            this.a.b.j.j = "all";
        }
    }
    ...
    void a(String str, a aVar) {
        ...
        if (this.l != null) {
            ...
            if (this.m != null) {
                ...
                this.i.b(ShareConstants.WEB_DIALOG_PARAM_DESCRIPTION, this.m.w.e);
                this.i.b(ShareConstants.WEB_DIALOG_PARAM_TITLE, this.m.w.f);
