...
class b implements Listener {
    ...
    void g() {
        ...
        if (q.c()) {
            ...
            String str2 = a.l.e.j == null ? BuildConfig.VERSION_NAME : a.l.e.j;
            String str3 = BuildConfig.VERSION_NAME + a.l.e.i;
            zVar.a(this.a.a.h);
            zVar.a("&carrier=");
    ...
    public void on_download_finished(ADCDownload download) {
        ...
        if (download.i) {
            ...
            if (b == null) {
                ...
                this.b = true;
                this.j.a();
                if (this.j.i == null || this.j.i.equals(BuildConfig.VERSION_NAME)) {
                    this.j.i = "all";
                }
                if (this.j.j == null || this.j.j.equals(BuildConfig.VERSION_NAME)) {
                    this.j.j = "all";
                }
                a.h();
                return;
    ...
    boolean a(g gVar) {
        if (gVar == null || !gVar.e(AnalyticsEvents.PARAMETER_SHARE_DIALOG_CONTENT_STATUS).equals(GraphResponse.SUCCESS_KEY) || !this.j.a(gVar.b("app"))) {
            return false;
        }
