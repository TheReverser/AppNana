...
class ab {
    ...
    static String c(String str) {
        return a(str, com.facebook.BuildConfig.VERSION_NAME);
    }

    static String a(String str, String str2) {
        if (str == null) {
            return com.facebook.BuildConfig.VERSION_NAME;
        }
        try {
    ...
    static boolean e() {
        return a.b().checkCallingOrSelfPermission("android.permission.VIBRATE") == 0;
    }
