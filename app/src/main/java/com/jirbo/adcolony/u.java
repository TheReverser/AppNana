...
class u implements Listener {
    ...
    void a(String str, AdColonyAd adColonyAd) {
        if (this.a != null && this.a.b != null && this.a.b.j != null && this.a.b.j.n != null && this.a.b.j.n.a(str) != null) {
            ...
            if (a != null && a.h != null && a.h.a != null) {
                ...
                gVar.b("request_denied_reason", a.ac);
                a(ShareConstants.WEB_DIALOG_RESULT_PARAM_REQUEST_ID, a.h.a, gVar, adColonyAd);
    ...
    void a(double d, AdColonyAd adColonyAd) {
        ...
        if (d >= d2) {
            if (d2 < 0.25d && d >= 0.25d) {
                if (AdColony.isZoneV4VC(adColonyAd.g) || !adColonyAd.k.equals(AnalyticsEvents.PARAMETER_SHARE_DIALOG_SHOW_NATIVE)) {
            ...
            if (d2 < 1.0d && d >= 1.0d && !adColonyAd.k.equals(AnalyticsEvents.PARAMETER_SHARE_DIALOG_SHOW_NATIVE)) {
    ...
    void b() {
        ...
        if (c != null) {
            ...
            for (int i = 0; i < c.i(); i++) {
                ...
                a aVar = new a();
                aVar.a = b.e("type");
                aVar.b = b.e(NativeProtocol.WEB_DIALOG_URL);
    ...
    void c() {
        ...
        for (int i = 0; i < this.c.size(); i++) {
            ...
            if (!aVar.i) {
                ...
                i gVar = new g();
                gVar.b("type", aVar.a);
                gVar.b(NativeProtocol.WEB_DIALOG_URL, aVar.b);
                if (aVar.c != null) {
    ...
    public void on_download_finished(ADCDownload download) {
        int i = HapticContentSDK.b044404440444ф04440444;
        a.r = true;
        this.e = true;
        this.d--;
        a aVar = (a) download.e;
        ...
        if (z && aVar.c != null) {
            g b = k.b(download.n);
            if (b != null) {
                z = b.e(AnalyticsEvents.PARAMETER_SHARE_DIALOG_CONTENT_STATUS).equals(GraphResponse.SUCCESS_KEY);
        ...
        if (z && aVar.a.equals("v4vc_callback")) {
            ...
            if (download.n.indexOf("vc_success") != -1) {
                ...
                this.a.a(false, BuildConfig.VERSION_NAME, 0);
            }
        }
        if (z) {
            ...
            if (aVar.f >= 24) {
                ...
                if (i2 <= HapticContentSDK.b044404440444ф04440444) {
                    i = i2;
                }
