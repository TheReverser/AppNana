...
public final class FlurryAgent {
    ...
    private static final hw<ja> c = new hw<ja>() {
        public /* synthetic */ void a(hv hvVar) {
            a((ja) hvVar);
        }
    ...
    public static void setReportLocation(boolean z) {
        if (VERSION.SDK_INT < 10) {
            ...
            je.a().a("ReportLocation", Boolean.valueOf(z));
        }
    }
    ...
    public static void setLocation(float f, float f2) {
        ...
        je.a().a("ExplicitLocation", location);
    }
    ...
    public static void setContinueSessionMillis(long j) {
        if (VERSION.SDK_INT < 10) {
            ...
            je.a().a("ContinueSessionMillis", Long.valueOf(j));
        }
    }
    ...
    public static void setLogEvents(boolean z) {
        if (VERSION.SDK_INT < 10) {
            ...
            je.a().a("LogEvents", Boolean.valueOf(z));
        }
    }
    ...
    public static void setCaptureUncaughtExceptions(boolean z) {
        if (VERSION.SDK_INT < 10) {
            ...
            je.a().a("CaptureUncaughtExceptions", Boolean.valueOf(z));
        }
    }
    ...
    public static void addOrigin(String str, String str2, Map<String, String> map) {
        if (VERSION.SDK_INT < 10) {
            ...
            try {
                ...
                ib.a(a, BuildConfig.VERSION_NAME, th);
            }
        }
    }
    ...
    public static void setPulseEnabled(boolean z) {
        if (VERSION.SDK_INT < 10) {
            ...
            je.a().a("ProtonEnabled", Boolean.valueOf(z));
        }
    }
    ...
    public static FlurryEventRecordStatus logEvent(String str, Map<String, String> map) {
        ...
        if (VERSION.SDK_INT < 10) {
            ...
            try {
                flurryEventRecordStatus = fu.a().a(str, map);
            } catch (Throwable th) {
                ib.a(a, "Failed to log event: " + str, th);
            }
        }
    ...
    public static FlurryEventRecordStatus logEvent(String str, Map<String, String> map, boolean z) {
        ...
        if (VERSION.SDK_INT < 10) {
            ...
            try {
                flurryEventRecordStatus = fu.a().a(str, map, z);
            } catch (Throwable th) {
                ib.a(a, "Failed to log event: " + str, th);
            }
        }
    ...
    public static void onError(String str, String str2, Throwable th) {
        if (VERSION.SDK_INT < 10) {
            ...
            try {
                ...
                ib.a(a, BuildConfig.VERSION_NAME, th2);
            }
        }
    }
    ...
    public static void setAge(int i) {
        if (VERSION.SDK_INT < 10) {
            ...
            je.a().a("Age", Long.valueOf(new Date(new Date(System.currentTimeMillis() - (((long) i) * 31449600000L)).getYear(), 1, 1).getTime()));
        }
    }
    ...
    public static void setGender(byte b) {
        ...
        switch (b) {
            case Gender.MALE /*0*/:
            case Gender.FEMALE /*1*/:
                je.a().a("Gender", Byte.valueOf(b));
                return;
            default:
                je.a().a("Gender", Byte.valueOf((byte) -1));
                return;
        }
    }
