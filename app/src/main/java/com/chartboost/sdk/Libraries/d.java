...
public final class d {
    ...
    protected static String a() {
        ...
        try {
            advertisingIdInfo = AdvertisingIdClient.getAdvertisingIdInfo(Chartboost.sharedChartboost().getContext());
        } catch (IOException e) {
        ...
        try {
            ...
            return advertisingIdInfo.getId().replace("-", BuildConfig.VERSION_NAME);
        }
    }
}
