...
public class t implements f {
    protected static final boolean a = s.b;
    ...
    public com.chartboost.sdk.impl.i a(com.chartboost.sdk.impl.k<?> r13) throws com.chartboost.sdk.impl.r {
        /*
        r12 = this;
    ...
    L_0x006f:
        r0 = move-exception;
        r0 = "socket";
        r1 = new com.chartboost.sdk.impl.q;
        r1.<init>();
        a(r0, r13, r1);
        goto L_0x0004;
    L_0x007b:
    ...
    L_0x00b0:
        ...
        r6 = r13.d();
        r3[r4] = r6;
        com.chartboost.sdk.impl.s.c(r2, r3);
    ...
    L_0x00ea:
        ...
        throw r1;
    L_0x00f0:
        r0 = new com.chartboost.sdk.impl.p;
        r0.<init>(r2);
        throw r0;
    L_0x00f6:
    ...
    L_0x00ff:
        ...
        goto L_0x00ae;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.chartboost.sdk.impl.t.a(com.chartboost.sdk.impl.k):com.chartboost.sdk.impl.i");
    }
    ...
    private void a(long j, k<?> kVar, byte[] bArr, StatusLine statusLine) {
        if (a || j > ((long) d)) {
            ...
            objArr[4] = Integer.valueOf(kVar.u().b());
            s.b(str, objArr);
        }
    }
    ...
    private static void a(String str, k<?> kVar, r rVar) throws r {
        ...
        try {
            u.a(rVar);
            kVar.a(String.format("%s-retry [timeout=%s]", new Object[]{str, Integer.valueOf(t)}));
        } catch (r e) {
            kVar.a(String.format("%s-timeout-giveup [timeout=%s]", new Object[]{str, Integer.valueOf(t)}));
            throw e;
        }
    }
    ...
    private byte[] a(HttpEntity httpEntity) throws IOException, p {
        ...
        try {
            ...
            byte[] toByteArray = zVar.toByteArray();
            return toByteArray;
        } finally {
            try {
