...
public final class StreamingAdReport$Factory$$InjectAdapter extends Binding<Factory> implements MembersInjector<Factory>, Provider<Factory> {
    private Binding<Factory> a;
    private Binding<StreamingAd.Factory> b;
    private Binding<Provider<StreamingAdReport>> c;
    ...
    public final void attach(Linker linker) {
        this.a = linker.requestBinding("com.vungle.publisher.db.model.StreamingAdPlay$Factory", Factory.class, getClass().getClassLoader());
        this.b = linker.requestBinding("com.vungle.publisher.db.model.StreamingAd$Factory", Factory.class, getClass().getClassLoader());
        this.c = linker.requestBinding("javax.inject.Provider<com.vungle.publisher.db.model.StreamingAdReport>", Factory.class, getClass().getClassLoader());
    ...
    public final void injectMembers(Factory object) {
        ...
        object.d = (StreamingAd.Factory) this.b.get();
