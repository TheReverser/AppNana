...
public final class AdReportExtra$Factory$$InjectAdapter extends Binding<Factory> implements MembersInjector<Factory>, Provider<Factory> {
    private Binding<Provider<AdReportExtra>> a;
    private Binding<a> b;
    ...
    public final void attach(Linker linker) {
        this.a = linker.requestBinding("javax.inject.Provider<com.vungle.publisher.db.model.AdReportExtra>", Factory.class, getClass().getClassLoader());
