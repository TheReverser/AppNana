...
public final class ReportStreamingAd$Factory$PlayFactory$$InjectAdapter extends Binding<PlayFactory> implements MembersInjector<PlayFactory>, Provider<PlayFactory> {
    ...
    public final void attach(Linker linker) {
        this.a = linker.requestBinding("com.vungle.publisher.protocol.message.ReportStreamingAd$Factory$PlayFactory$UserActionFactory", PlayFactory.class, getClass().getClassLoader());
